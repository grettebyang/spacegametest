...
class SpaceShip
{
    ...
    //Rigidbody component, Continuous force component?
    ...
    //These could go in a Transform component
    ...
    //CollisionMesh component, last in array because it should be updated after everything else
